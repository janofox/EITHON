    ...
    try:
        ...
        if event.reply_to_msg_id:
            ...
            if previous_message.from_id is None:
                if not noedits:
                    await edit_delete(catevent, "𓆩𓆩 حسنًا ، هذا مسؤول مجهول 𓆪𓆪")
                return None, None
            ...
            if not noedits:
                await edit_delete(
                    catevent, "قـم بوضـع اسـم المسـتـخدم أو معرف المسـتـخدم أو الرد!", 5
                )
            return None, None
    except Exception as e:
        LOGS.error(str(e))
    if not noedits:
        await edit_delete(catevent, "𓆩𓆩 قـم بوضـع اسـم الـمسـتخدم أو معرف المـستـخدم أو الرد!𓆪𓆪")
    return None, None
