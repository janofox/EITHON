...
async def gcast(event):
    if not event.out and not is_fullsudo(event.sender_id):
        return await edit_or_reply(event, "**𓆩𓆩𖠄هـذا الامـر مقـيد 𓆪𓆪𓆪𓆪𓆪𓆪**")
    xx = event.pattern_match.group(1)
    if not xx:
        return edit_or_reply(event, "**𓆩𓆩𖠄𖠄 ⦙   يجـب وضـع نـص مع الامـر للتوجيـه 𓆪𓆪𓆪𓆪𓆪𓆪**")
    tt = event.text
    msg = tt[6:]
    event = await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙   يتـم الـتوجيـة للـمجموعـات انتـظر قليلا𓆪𓆪𓆪𓆪**")
    er = 0
    done = 0
...
async def _(event):
    ...
    try:
        ...
        no_admin_privilege_message = await event.client.send_message(entity=event.chat_id, message=f"""**𖠄 ⦙   تحذير تكرار فـي المجموعة : لـ** @تاك للادمنيه  : [User](tg://user?id={event.message.sender_id}) لقد قام بتكرار الرسائل . `{str(e)}`""", reply_to=event.message.id)
        await asyncio.sleep(4)
        await no_admin_privilege_message.edit("**𓆩𓆩𖠄 ⦙ هذا الشخص الذي قام بتكرار الرسائل والازعاج 𓆪𓆪**")
    else:
        await event.client.send_message(entity=event.chat_id, message=f"""**𓆩𓆩𖠄 ⦙ تحذير تكرار فـي المجموعة : لـ** [User](tg://user?id={event.message.sender_id}) تم تقيد الشخص بسبب عمل تكرار للرسائل والازعاج.""", reply_to=event.message.id)
@iqthon.on(admin_cmd(pattern=f"{ALLPRIVATE} ?(.*)$"))    
async def gucast(event):
    if not event.out and not is_fullsudo(event.sender_id):
        return await edit_or_reply(event, "**𓆩𓆩𖠄هـذا الامـر مقـيد 𓆪𓆪**")
    xx = event.pattern_match.group(1)
    if not xx:
        return edit_or_reply(event, "**𓆩𓆩𖠄 ⦙  يجـب وضـع نـص مع الامـر التوجيه 𓆪𓆪**")
    tt = event.text
    msg = tt[7:]
    await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙   يتـم الـتوجيـة للخـاص انتـظر قليل 𓆪𓆪**")
    er = 0
    done = 0
    async for x in bot.iter_dialogs():
        if x.is_user and not x.entity.bot:
            ...
            try:
                ...
                er += 1
    await event.edit(f"𖠄 ⦙   تـم بنـجـاح فـي {done} من الـدردشـات , خطـأ فـي {er} من الـدردشـات")
async def spam_function(event, sandy, cat, sleeptimem, sleeptimet, DelaySpam=False):
    ...
    if len(cat) == 2:
        ...
        if BOTLOG:
            if DelaySpam is not True:
                if event.is_private:
                    await event.client.send_message(BOTLOG_CHATID, "**𖠄 ⦙   التڪـرار ♽**\n" + f"** ⦙ تم تنفيذ التكرار بنجاح في ▷** [User](tg://user?id={event.chat_id}) **الدردشـة مـع** {counter} **عدد المرات مع الرسالة أدنا**")
                else:
                    await event.client.send_message(BOTLOG_CHATID, "**𖠄 ⦙   التڪـرار  ♽**\n" + f"**𖠄 ⦙   تم تنفيذ التكرار بنجاح في ▷** {get_display_name(await event.get_chat())}(`{event.chat_id}`) **مـع** {counter} **عدد المرات مع الرسالة أدنا**")
            elif event.is_private:
                await event.client.send_message(BOTLOG_CHATID, "**𖠄 ⦙   التكرار الوقتي 💢**\n" + f"**𖠄 ⦙ تم تنفيذ التكرار الوقتي بنجاح في ▷** [User](tg://user?id={event.chat_id}) **الدردشـة مـع** {counter} **عدد المرات مع الرسالة أدناه مع التأخير** {sleeptimet} ** الثوانـي ⏱**")
            else:
                await event.client.send_message(BOTLOG_CHATID, "**𖠄 ⦙   التكرار الوقتي 💢**\n" + f"**𖠄 ⦙   تم تنفيذ التكرار الوقتي  بنجاح في ▷** {get_display_name(await event.get_chat())}(`{event.chat_id}`) **مـع** {counter} **عدد المرات مع الرسالة أدناه مع التأخير** {sleeptimet} ** الثوانـي ⏱**")
    ...
    if DelaySpam is not True:
        if BOTLOG:
            if event.is_private:
                await event.client.send_message(BOTLOG_CHATID, "**𖠄 ⦙   التڪـرار  ♽**\n" + f"**𖠄 ⦙ تم تنفيذ التكرار بنجاح في ▷** [User](tg://user?id={event.chat_id}) **الدردشـة مـع** {counter} **رسائـل الـ  ✉️ :** \n" + f"𖠒 ⦙   `{spam_message}`")
            else:
    ...
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**𓆩𓆩𖠄اكتب الامر بشكل صحيح 𓆪𓆪**")
    await iqthon.edit(f"**تم𓆩𓆩𖠄 بدء وضع الكتابة الوهمية لـ {iq} من الثوانـي 𓆪𓆪**")
...
async def spammer(event):
    ...
    try:
        ...
        return await edit_delete(event, "𖠄 ⦙  إستخـدم بناء الجملة المناسب للإزعاج، صيغة Foe تشير إلىٰ قائمة التعليمات 💡")
    if counter > 50:
        sleeptimet = 0.5
        sleeptimem = 1
    else:
...
async def save_welcome(event):
    ...
    if msg and msg.media and not string:
        if BOTLOG_CHATID:
            await event.client.send_message(BOTLOG_CHATID, f"𖠄 ⦙  رسالة الترحيب 🔖 : \n𖠒 ⦙  ايدي الدردشة 🆔 : {event.chat_id}\n𖠄 ⦙  يتم حفظ الرسالة التالية كملاحظة ترحيبية لـ 🔖 : {event.chat.title}, ")
        ...
        string = rep_msg.text
    success = "**𓆩𓆩𖠄 ⦙ تم حفظ الترحيب بهذه الدردشة بنجاح 𓆪𓆪**"
    ...
    await edit_or_reply("𓆩𓆩𖠄 ⦙ حدث خطأ أثناء وضع ترحيب في هذه المجموعة 𓆪𓆪️")
@iqthon.on(admin_cmd(pattern="مسح الترحيبات(?: |$)(.*)"))    
async def del_welcome(event):
    if rm_welcome_setting(event.chat_id) is True:
        await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ تم مسح جميع الرسائل الترحيبية لهذه الدردشة بنجاح 𓆪𓆪**")
    else:
        await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙  لم يتم حفظ أي رسائل ترحيبية هنا 𓆪𓆪**")
Tnsmeetst = {}
...
async def show_welcome(event):
    cws = get_current_welcome_settings(event.chat_id)
    if not cws:
        return await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ لم يتم حفظ أي رسائل ترحيبية هنا 𓆪𓆪**")
    if cws.f_mesg_id:
        msg_o = await event.client.get_messages(entity=BOTLOG_CHATID, ids=int(cws.f_mesg_id))
        await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ أنا الآن أقوم بالترحيب بالمستخدمين الجدد مع هذه الرسالة 𓆪𓆪**")
...
async def del_welcome(event):
    ...
    if input_str == "تشغيل":
        if gvarstatus("clean_welcome") is None:
            return await edit_delete(event, "**𓆩𓆩𖠄 ⦙ تم تشغيلها بالفعل ✅𓆪𓆪**")
        delgvar("clean_welcome")
        return await edit_delete(event, "**𓆩𓆩𖠄 ⦙ من الآن رسالة الترحيب السابقة سيتم حذفها وسيتم إرسال رسالة الترحيب الجديدة 𓆪𓆪**")
    if gvarstatus("clean_welcome") is None:
        addgvar("clean_welcome", "false")
        return await edit_delete(event, "**𓆩𓆩𖠄 ⦙ من الآن لن يتم حذف رسالة الترحيب السابقة 𓆪𓆪**")
    await edit_delete(event, "**𓆩𓆩𖠄 ⦙ تم إيقافها بالفعل 𓆪𓆪**")
@iqthon.on(admin_cmd(pattern="موقع(?: |$)(.*)"))    
async def gps(event):
    reply_to_id = await reply_id(event)
    input_str = event.pattern_match.group(1)
    catevent = await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ جاري العثـور على الموقع … 𓆪𓆪**")
    ...
    if geoloc:
        ...
        await event.client.send_file(
            ...
            caption=f"**𖠄 ⦙ الموقـع 𖠕  : **`{input_str}`", reply_to=reply_to_id)
        await catevent.delete()
    else:
        await catevent.edit("𖠄 ⦙ عـذراً، لـم أستطـع إيجـاده")
    ...
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**𓆩𓆩𖠄اكتب الامر بشكل صحيح 𓆪𓆪**")
    await iqthon.edit(f"**𓆩𓆩𖠄تم بدء وضع فيديو وهمي لـ {iq} من الثوانـي 𓆪𓆪**")
    async with iqthon.client.action(iqthon.chat_id, "record-video"):
        await asyncio.sleep(iq)
@iqthon.on(admin_cmd(pattern="ازعاج(?: |$)(.*)"))    
async def echo(event):
    if event.reply_to_msg_id is None:
        return await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ يرجى الرد على الشخص الذي تـريد ازعاجه 𓆪𓆪**")
    catevent = await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ يتم تفعيل هذا الامر انتظر قليلا 𓆪𓆪**")
    ...
    if is_echo(chat_id, user_id):
        return await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ تـم تفـعيل وضـع الازعاج على الشخص بنجاح 𓆪𓆪**")
    try:
        addecho(chat_id, user_id, chat_name, user_name, user_username, chat_type)
    except Exception as e:
        await edit_delete(catevent, f"☭ ⦙   Error:\n`{str(e)}`")
    else:
        await edit_or_reply(catevent, "**𖠄 ⦙ تـم تفعـيل امـر التقليد علـى هذا الشـخص**\n **𖠄 ⦙ سـيتم تقليـد جميع رسائلـه هـنا**")
...
async def echo(event):
    ...
    if input_str:
        lecho = get_all_echos()
        if len(lecho) == 0:
            return await edit_delete(event, "**𓆩𓆩𖠄 ⦙ لم يتم تفعيل الازعاج بالاصل لاي شخص ️𓆪𓆪**")
        try:
            remove_all_echos()
        except Exception as e:
            await edit_delete(event, f"**𓆩𓆩𖠄 ⦙ هناك خطا :𓆪𓆪**\n**`{str(e)}`𓆪𓆪**", 10)
        else:
            await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ تـم ايقاف وضـع الازعاج على الجميع بنجاح .𓆪𓆪**")
    else:
        lecho = get_echos(event.chat_id)
        if len(lecho) == 0:
            return await edit_delete(event, "**𓆩𓆩𖠄 ⦙ لم يتم تفعيل الازعاج بالاصل لاي شخص 𓆪𓆪**")
        try:
...
async def echo(event):  
    input_str = event.pattern_match.group(1)
    private_chats = ""
    output_str = "**𖠄 ⦙ قائمه الاشخاص الذين تم ازعاجهم :**\n\n"
    if input_str:
        lsts = get_all_echos()
        group_chats = ""
        if len(lsts) > 0:
            ...
            return await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ لم يتم تفعيل ازعاج  اي شخص 𓆪𓆪**")
        if private_chats != "":
            output_str += "**𖠄 ⦙ الـدردشـات الـخاصة **\n" + private_chats + "\n\n"
        if group_chats != "":
            output_str += "**𖠄 ⦙ دردشـات الـمجموعات **\n" + group_chats
    else:
        lsts = get_echos(event.chat_id)
        if len(lsts) <= 0:
            return await edit_or_reply(event, "**𓆩𓆩𖠄لم يتم تفعيل الازعاج بالاصل في هذه الدردشه 𓆪𓆪**")
        ...
        for echos in lsts:
            if echos.user_username:
                ...
                private_chats += (f"☞ [{echos.user_name}](tg://user?id={echos.user_id})\n")
        output_str = f"**𖠄 ⦙ الاشخاص الذي تم تقليدهم في هذه الدردشه :**\n" + private_chats
    ...
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب𓆩𓆩𖠄 الامر بشكل صحيح 𓆪𓆪**")
    await iqthon.edit(f"**𓆩𓆩𖠄 تم بدء وضع صوت وهمي لـ {iq} من الثوانـي 𓆪𓆪**")
...
async def iq(cloneiq):  
    ...
    if reply:
            ...
            if p_type is not None:
                for ty in p_type:
                    if ty in Tnsmeet:
                        ...
                        error += f"\n**𖠄 ⦙  هنـاك خطـا فـي تركـيب الجمـلة 🔩 :**"
                    else:
                        error += f"\n\n𖠄 ⦙   `{ty}`  **هنـاك خطـا فـي تركـيب الجمـلة 🔩 :**"
            else:
                count += 1
        ...
        if p_type != "s" and input_str.isnumeric():
            for ty in p_type:
                if ty in Tnsmeet:
                    ...
                    error += f"\n**𖠄 ⦙ لا تستطـيع استـخدام امر التنظيف عبر البحث مع الاضافه 🔎**"
                else:
        ...
        error += "\n**𖠄 ⦙ لم يتـم تحـديد الرسـالة أرسل  (.الاوامر ) و رؤية اوامر التنظيف  📌**"
    if msgs:
        await cloneiq.client.delete_messages(chat, msgs)
    if count > 0:
        result += "𖠄 ⦙ تـم الأنتـهاء من التـنظيف السـريع \n 𖠄 ⦙ لقـد  تـم حـذف \n 𖠄 ⦙ عـدد " + str(count) + " من الـرسائـل 🗑️"
    if error != "":
        result += f"\n\n**𖠄 ⦙  عـذرا هنـاك خطـأ ❌:**{error}"
    if result == "":
        result += "**𓆩𓆩𖠄 ⦙ لا تـوجد رسـائل لـتنظيفها 𓆪𓆪**"
    hi = await cloneiq.client.send_message(cloneiq.chat_id, result)
    if BOTLOG:
        await cloneiq.client.send_message(BOTLOG_CHATID, f"**𖠄 ⦙ حـذف الـرسائل 🗳️** \n{result}")
    await sleep(5)
    await hi.delete()
    ...
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**𓆩𓆩𖠄اكتب الامر بشكل صحيح 𓆪𓆪**")
    await iqthon.edit(f"**𓆩𓆩𖠄تم بدء وضع لعب وهمي لـ {iq} من الثوانـي 𓆪𓆪**")
    async with iqthon.client.action(iqthon.chat_id, "game"):
        await asyncio.sleep(iq)  
@iqthon.iq_cmd(pattern="قرائه(?:\s|$)([\s\S]*)",)
async def ocriq(iqthonevent):
    iqqevent = await edit_or_reply(iqthonevent, "**𓆩𓆩𖠄جاري قرائه الصوره ...𓆪𓆪**")
...
async def add_new_filter(new_handler):
    ...
    if msg and msg.media and not string:
        if BOTLOG:
            await new_handler.client.send_message(BOTLOG_CHATID, f"**𓆩𓆩𖠄 ⦙   اضـافه ردّ ⎗ :** \n**𖠄 ⦙ آيـدي الدردشـة :** {new_handler.chat_id} \n**𖠄 ⦙ آثـار ⌬ :** {keyword}\n\n**𖠄 ⦙ تـم حفظ الرسـالة التاليـة ڪردّ على الكلمـة في الدردشـة، يرجـى عـدم حذفهـا ✻𓆪𓆪**")
            ...
            await edit_or_reply(new_handler, "**𓆩𓆩𖠄 ⦙ لحفـظ الوسائـط ڪرد يتوجـب تعييـن - PRIVATE_GROUP_BOT_API_ID. 💡𓆪𓆪**")
            return
    elif new_handler.reply_to_msg_id and not string:
        rep_msg = await new_handler.get_reply_message()
        string = rep_msg.text
    success = "**𓆩𓆩𖠄 ⦙ تـم حفـظ الـرد {} بنجـاح ✓𓆪𓆪**"
    ...
    await edit_or_reply(new_handler, f"**𓆩𓆩𖠄 ⦙ حـدث خطـأ عنـد تعييـن الـردّ ✕ :𓆪𓆪** {keyword}")
    ...
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**𓆩𓆩𖠄اكتب الامر بشكل صحيح 𓆪𓆪**")
    await iqthon.edit(f"**تم𓆩𓆩𖠄 بدء وضع موقع وهمي لـ {iq} من الثوانـي 𓆪𓆪**")
    async with iqthon.client.action(iqthon.chat_id, "location"):
        await asyncio.sleep(iq)
@iqthon.on(admin_cmd(pattern="جميع الردود(?: |$)(.*)"))    
async def on_snip_list(event):
    OUT_STR = "**𓆩𓆩𖠄 ⦙ لايوجـد أيّ رد في هـذه الدردشـة  ✕𓆪𓆪**"
    filters = get_filters(event.chat_id)
    for filt in filters:
        if OUT_STR == "**𓆩𓆩𖠄 ⦙ لايوجـد أيّ رد في هـذه الدردشـة  ✕𓆪𓆪**":
            OUT_STR = "**𖠄 ⦙ الـردود المتوفـرة في هـذه الدردشـة ⎙ :** \n"
        OUT_STR += "▷  `{}`\n".format(filt.keyword)
    await edit_or_reply(event, OUT_STR, caption="**𓆩𓆩𖠄 ⦙ الـردود المتاحـة في الدردشـة الحاليـة ⎙ 𓆪𓆪**", file_name="filters.text")
Tnsmeet1 = {}
...
async def remove_a_filter(r_handler):
    ...
    if not remove_filter(r_handler.chat_id, filt):
        await r_handler.edit("**𓆩𓆩𖠄 ⦙ الـرد {} غيـر موجـود ️𓆪𓆪**".format(filt))
    else:
        await r_handler.edit("**𓆩𓆩𖠄 ⦙ تـم حـذف الـردّ {} بنجـاح ✓𓆪𓆪**".format(filt))
@iqthon.on(admin_cmd(pattern="مسح جميع الردود(?: |$)(.*)"))    
async def on_all_snip_delete(event):
    filters = get_filters(event.chat_id)
    if filters:
        remove_all_filters(event.chat_id)
        await edit_or_reply(event, f"**𓆩𓆩𖠄 ⦙ تـم حـذف ردود الدردشـة الحاليـة بنجـاح ✓𓆪𓆪**")
    else:
        await edit_or_reply(event, f"**𓆩𓆩𖠄 ⦙ لايوجـد أيّ رد في هـذه المجموعـة ✕𓆪𓆪**")
...
async def _(event):
    ...
    if ";" in input_str:
        ...
        if not input_str:
            return await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ عـذرا هـذا النص خـطأ 𓆪𓆪**")
        text = input_str
        lan = "en"
    catevent = await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ يـتم الـتسجيل أنتـظر 𓆪𓆪**")
    ...
    try:
        ...
        os.remove(required_file_name)
        await edit_delete(catevent, "**𓆩𓆩𖠄 ⦙ النـص الـذي اخـترتـة  {} في هـذا البـصمة خـلال 🔎 {} ثـانيـة 🔩 𓆪𓆪".format(text[0:20], ms),)
    except Exception as e:
        await edit_or_reply(catevent, f"**𓆩𓆩𖠄 ⦙ عـذرا هنـاك خطـأ هـوة 🚫 :𓆪𓆪**\n`{str(e)}`")
@iqthon.on(admin_cmd(pattern="تحذير تكرار(?:\s|$)([\s\S]*)"))
async def _(event):
    input_str = event.pattern_match.group(1)
    event = await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙  جـاري تحديـث إعـدادات الـ كملها ↯𓆪𓆪**")
    await asyncio.sleep(2)
    try:
        sql.set_flood(event.chat_id, input_str)
        sql.__load_flood_settings()
        await event.edit(f"**𓆩𓆩𖠄 ⦙ تم تحديـث تحذير تكرار إلى : {input_str} في الدردشـة الحاليـة ⌂𓆪𓆪**")
    except Exception as e:
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        return await edit_delete(event, "**𓆩𓆩𖠄 ⦙ للترجمه يجـب الـرد على الرساله واكتب .ترجمه ar 𓆪𓆪**", time=5)
    text = deEmojify(text.strip())
    lan = lan.strip()
    Translator()
    try:
        ...
        output_str = f"**𖠄 ⦙ تمت الترجمه مـن :** {LANGUAGES[translated.src].title()}\n **𖠄 ⦙ الـى ** {LANGUAGES[lan].title()} \n\n{after_tr_text}"
        await edit_or_reply(event, output_str)
...
async def iq(event):
  if not event.is_reply:
    return await event.edit('**𓆩𓆩𖠄يجـب عـليك الـرد عـلى صـورة ذاتيـة الـتدمير 𓆪𓆪**')
  ogtah = await event.get_reply_message()
  pic = await ogtah.download_media()
  await bot.send_file('me', pic, caption=f"""**𓆩𓆩𖠄الصـورة الوقتيه 𓆪𓆪**\- **DEV** : @M_2_F 𖠒 @alw_sh313""")
  await event.delete()
...
async def _(event):
    ...
    if reply:
        ...
        result = event.date
    await edit_or_reply(event, f"**𓆩𓆩𖠄هذا تاريخ الرساله والوقت :𓆪𓆪** `{yaml_format(result)}`")
    ...
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**𓆩𓆩𖠄اكتب الامر بشكل صحيح 𓆪𓆪**")
    await iqthon.edit(f"**𓆩𓆩𖠄تم بدء وضع جهه اتصال وهمي لـ {iq} من الثوانـي 𓆪𓆪**")
...
async def _(event):
    ...
    if not markdown_note:
        return await edit_delete(event, "**𖠄 ⦙ مـا هـو النـص الـذي يجـب أن أستخدمـه ␦** : \n𖠄 ⦙   أولا قـم بكتابه الامر وبجانبه الكلمه ورابط\n𖠄 ⦙   كمثال 👇 :\n𖠒 ⦙ `.ماركدون شفافية اهلا بك في كوكل [google]<buttonurl:https://www.google.com>`")
...
async def iq(cloneiq):  
    ...
    if reply:
        if input_str and input_str.isnumeric():
            ...
            for ty in p_type:
                if ty in Tnsmeet1:
                    ...
                    error += f"\n𖠄 ⦙ `{ty}`  **هنـاك خطـا فـي تركـيب الجمـلة 𖠒:**"
        else:
            async for msg in cloneiq.client.iter_messages(chat, min_id=cloneiq.reply_to_msg_id - 1 ):
                count += 1
                msgs.append(msg)
        ...
        error += "\n**𖠄 ⦙ لم يتـم تحـديد الرسـالة أرسل  (.الاوامر ) و رؤية اوامر التنظيف 𖠄**"
    if msgs:
        await cloneiq.client.delete_messages(chat, msgs)
    if count > 0:
        result += "𖠄 ⦙ تـم الأنتـهاء من التـنظيف السـريع \n 𖠄 ⦙ لقـد  تـم حـذف \n 𖠄 ⦙ عـدد " + str(count) + " من الـرسائـل 🗑️"
...
async def iq(iqthon):
    ...
    chat = await iqthon.get_input_chat()
    async for x in iqthon.client.iter_participants(chat, 200):
        mentions += f" \n𖠄 ⦙ ⵧ〈[{x.first_name}](tg://user?id={x.id})〉"
    await iqthon.client.send_message(iqthon.chat_id, mentions)
    await iqthon.delete()
...
async def calculator(event):
    ...
    event = await edit_or_reply(event, "**𓆩𓆩𖠄 ⦙ جـاري حسـاب المسـئلـة 𓆪𓆪**")
    ...
    if exc:
        ...
        evaluation = "**𓆩𓆩𖠄 ⦙ عـذار المسـئلة لااقـدر حلـها أو هنـاك خطـأ بتـرتيـب السـؤال 🆘𓆪𓆪**"
    final_output = "**𓆩𓆩𖠄 ⦙   المسئلة : `{}` \n 𖠄 ⦙ الجواب **: `{}` \n".format(cmd, evaluation)
...
async def remove_iq(event):
    ...
    if event.reply_to_msg_id and not input_str:
        reply_message = await event.get_reply_message()
        catevent = await edit_or_reply(event, "𓆩𓆩`تحليل هذه الصورة / الملصق...`𓆪𓆪")
...
async def iq(event):
    mentions = "@تاك للادمنيه : **𓆩𓆩𖠄 ⦙  تم رصـد إزعـاج 𓆪𓆪**"
...
async def _(event):
    ...
    await edit_or_reply(event, "**𓆩𓆩𖠄︙تم اضافة {} الكلمة في قائمة المنع بنجاح 𓆪𓆪**".format(len(to_blacklist)),)
    ...
    if iq_src:
        if input_str and input_str.isnumeric():
            ...
            try:
                await iq_src.delete()
                if BOTLOG:
                    await msg1.client.send_message(BOTLOG_CHATID, "**𓆩𓆩𖠄 ⦙ حـذف الـرسائل \n 𖠒 ⦙ تـم حـذف الـرسالة بـنجاح 𓆪𓆪**")
            except rpcbaseerrors.BadRequestError:
                if BOTLOG:
                    await msg1.client.send_message(BOTLOG_CHATID, "**𓆩𓆩𖠄 ⦙ عـذرا لايـمكن الـحذف بـدون  صلاحيـات ألاشـراف 𓆪𓆪**")
        elif input_str:
            if not input_str.startswith("var"):
                await edit_or_reply(msg1, "**𓆩𓆩𖠄 ⦙ عـذرا الـرسالة غيـر موجـودة ❌ 𓆪𓆪**")
        else:
            try:
                await iq_src.delete()
                await msg1.delete()
                if BOTLOG:
                    await msg1.client.send_message(BOTLOG_CHATID, "**𓆩𓆩𖠄 ⦙ حـذف الـرسائل️ \n 𖠄 ⦙ تـم حـذف الـرسالة بـنجاح 𓆪𓆪**")
            except rpcbaseerrors.BadRequestError:
                await edit_or_reply(msg1, "**𓆩𓆩𖠄 ⦙ عـذرا  لا استـطيع حـذف الرسـالة. ⁉️𓆪𓆪**")
    elif not input_str:
        await msg1.delete()
...
async def iq(nshkh):
    ...
    if nshkh.reply_to_msg_id:
        ...
        await nshkh.edit("**𓆩𓆩𖠄 ⦙ قم برد على الرساله 𓆪𓆪**")
